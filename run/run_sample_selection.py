...
from exp.exp_sample_selection import Exp_Sample_Selection
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_not_shuffle', type=str, default='False', help='batch not shuffle')
    ...
    parser.add_argument('--additional', type=str, default=None, help='additional loss function(window, fourier, laguerre, legendre, chebyshev, hermite, loss_network, quantile)')
    ...
    # additional loss - loss network
    parser.add_argument('--repr_loss', type=str, default='CKA', help='type of representation loss calculation')
    ...
    parser.add_argument('--use_dilate', type=bool, default=False, 
    ...
    parser.add_argument('--vali_metric', type=str, default=None, help='validation metric(dilate)')
    ...
    # Sample Selection
    parser.add_argument('--sample_selection', type=str, default='./sample_selection/', help='path for sample selection')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            #exp.train(setting)
            exp.train_data_selection()

            print('>>>>>>>testing : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting))
            #exp.test(setting)
            exp.test_data_selection()
