...
#SBATCH --job-name=SampleSelection_ETTm1
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
python -u /home/jinkwanjang/Time-Series-Library/run_sample_selection.py \
  ...
  --n_heads 2 \
  --itr 1 \
  --sample_selection ./sample_selection/ETTm1_96_96/ \
...
python -u /home/jinkwanjang/Time-Series-Library/run_sample_selection.py \
  ...
  --n_heads 2 \
  --itr 1 \
  --sample_selection ./sample_selection/ETTm1_96_192/ \
  --batch_not_shuffle True \
...
python -u /home/jinkwanjang/Time-Series-Library/run_sample_selection.py \
  ...
  --n_heads 2 \
  --itr 1 \
  --sample_selection ./sample_selection/ETTm1_96_336/ \
  --batch_not_shuffle True \
...
python -u /home/jinkwanjang/Time-Series-Library/run_sample_selection.py \
  ...
  --n_heads 2 \
  --itr 1 \
  --sample_selection ./sample_selection/ETTm1_96_720/ \
  --batch_not_shuffle True \
