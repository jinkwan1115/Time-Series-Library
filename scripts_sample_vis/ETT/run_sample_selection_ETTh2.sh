...
#SBATCH --job-name=SampleSelection_ETTh2
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
python -u /home/jinkwanjang/Time-Series-Library/run_sample_selection.py \
  ...
  --n_heads 2 \
  --itr 1 \
  --sample_selection ./sample_selection/ETTh2_96_96/ \
...
python -u /home/jinkwanjang/Time-Series-Library/run_sample_selection.py \
  ...
  --n_heads 2 \
  --itr 1 \
  --sample_selection ./sample_selection/ETTh2_96_192/ \
  --batch_not_shuffle True \
...
python -u /home/jinkwanjang/Time-Series-Library/run_sample_selection.py \
  ...
  --n_heads 2 \
  --itr 1 \
  --sample_selection ./sample_selection/ETTh2_96_336/ \
  --batch_not_shuffle True \
...
python -u /home/jinkwanjang/Time-Series-Library/run_sample_selection.py \
  ...
  --n_heads 2 \
  --itr 1 \
  --sample_selection ./sample_selection/ETTh2_96_720/ \
  --batch_not_shuffle True \
