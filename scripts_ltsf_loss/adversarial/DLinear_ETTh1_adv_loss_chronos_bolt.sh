...
#SBATCH --job-name=DLinear_ETTh1_adv_loss_lambda_0.5_chronos_bolt
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
#SBATCH --output=/home/jinkwanjang/Time-Series-Library/log/DLinear_input_96_adv_loss/S-%x.%j.out
