...
if __name__ == '__main__':
    ...
    parser.add_argument('--loss_model_path', type=str, default=None, help='path to loss model')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_cout{}_el{}_dl{}_df{}_expand{}_dc{}_fc{}_eb{}_ph{}_{}_{}'.format(
                args.task_name,
                args.model_id,
                args.model,
                args.data,
